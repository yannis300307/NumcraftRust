        ...
        match self.get_dir() {
            QuadDir::Front => (
                Triangle {
                    ...
                    t1: Vector2::new(tex_x + 0.005, tex_y + 0.005), // That's a dame good workaround
                    t2: Vector2::new(tex_x + 0.005, tex_y + 0.995),
                    t3: Vector2::new(tex_x + 0.995, tex_y + 0.995),
                ...
                Triangle {
                    ...
                    t1: Vector2::new(tex_x + 0.995, tex_y + 0.995),
                    t2: Vector2::new(tex_x + 0.995, tex_y + 0.005),
                    t3: Vector2::new(tex_x + 0.005, tex_y + 0.005),
                    texture_id: self.texture_id,
                    light,
                },
            ),
            QuadDir::Back => (
                Triangle {
                    ...
                    t1: Vector2::new(tex_x + 0.005, tex_y + 0.995),
                    t2: Vector2::new(tex_x + 0.995, tex_y + 0.995),
                    t3: Vector2::new(tex_x + 0.995, tex_y + 0.005),
                    texture_id: self.texture_id,
                    light,
                },
                Triangle {
                    ...
                    t1: Vector2::new(tex_x + 0.995, tex_y + 0.005),
                    t2: Vector2::new(tex_x + 0.005, tex_y + 0.005),
                    t3: Vector2::new(tex_x + 0.005, tex_y + 0.995),
                    texture_id: self.texture_id,
                    light,
                },
            ),
            QuadDir::Bottom => (
                Triangle {
                    ...
                    p2: Vector3::new(pos_x_plus_one, pos_y, pos_z_plus_one),
                    p3: Vector3::new(pos_x, pos_y, pos_z_plus_one),
                    t1: Vector2::new(tex_x + 0.005, tex_y + 0.005),
                    t2: Vector2::new(tex_x + 0.005, tex_y + 0.995),
                    t3: Vector2::new(tex_x + 0.995, tex_y + 0.995),
                    texture_id: self.texture_id,
                    light,
...
impl Triangle2D {
    pub fn to_small(&self) -> SmallTriangle2D {
        ...
        SmallTriangle2D {
            pos,
            t1: self.t1.map(|x| x as f16),
            t2: self.t2.map(|x| x as f16),
            t3: self.t3.map(|x| x as f16),
            texture_id: self.texture_id,
            light: self.light,
        }
    }
